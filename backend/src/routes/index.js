...
const { fiscalObligationRouter } = require("../modules/fiscal-obligations/routes/fiscal-obligation.routes");
...
apiRouter.use("/fiscal-obligations", fiscalObligationRouter);
